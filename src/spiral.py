...
def main():
    ...
    var_Canvas3 = GraphWin("Canvas3", 800, 800)     # todos as novas pens criadas vão desenhar neste canvas, até que um novo canvas seja criado


    # criar pen_class default, e modificar-lhe os atributos indicados 
    var_PenType3 = {}
    var_PenType3["pos"] = (10,10)
    var_PenType3["color"] = "red"
    var_PenType3["orientation"] = 0
    var_PenType3["thickness"] = 1
    var_PenType3["pressure"] = 0
    var_PenType3["levitate"] = False


    # meter os valores desejados na pen_class criada
    penClass_set_attribute( var_PenType3, 'color', "blue"  )
    penClass_set_attribute( var_PenType3, 'position', (400, 400)  )
    penClass_set_attribute( var_PenType3, 'orientation', 0  )
    penClass_set_attribute( var_PenType3, 'thickness', 3  )
    penClass_set_attribute( var_PenType3, 'pressure', 0  )



    var_p3 = Pen(  var_PenType3 )
    ...
    pen_action(var_Canvas3, var_p3, "down")


    var_i = int(0)
    while( (var_i < 36) ):
        pen_action(var_Canvas3, var_p3, "forward", value=var_length)
        pen_action(var_Canvas3, var_p3, "right", value=var_angle, units='º')
        var_length = ((var_length + 5))
        var_i = ((var_i + 1))


    pen_action(var_Canvas3, var_p3, "up")
    ...
    var_Canvas4.setBackground("orange")
    ...
    pen_action(var_Canvas4, var_p3, "down")


    var_p3.set_attribute( 'position', (400, 400)  )


    var_i = (0)
    while( (var_i < 36) ):
        pen_action(var_Canvas4, var_p3, "forward", value=var_length)
        pen_action(var_Canvas4, var_p3, "right", value=var_angle)
        var_length = ((var_length + 5))
        var_i = ((var_i + 1))


    pen_action(var_Canvas4, var_p3, "up")
    try:
        var_Win.getMouse()
        var_Win.close()
    except:

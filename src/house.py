...
def main():
    ...
    var_CanvasHouse = GraphWin("CanvasHouse", 600, 600)     # todos as novas pens criadas vão desenhar neste canvas, até que um novo canvas seja criado


    # criar pen_class default, e modificar-lhe os atributos indicados 
    var_PenTypeHouse = {}
    var_PenTypeHouse["pos"] = (10,10)
    var_PenTypeHouse["color"] = "red"
    var_PenTypeHouse["orientation"] = 0
    var_PenTypeHouse["thickness"] = 1
    var_PenTypeHouse["pressure"] = 0
    var_PenTypeHouse["levitate"] = False


    # meter os valores desejados na pen_class criada
    penClass_set_attribute( var_PenTypeHouse, 'color', "black"  )
    penClass_set_attribute( var_PenTypeHouse, 'position', (100, 300)  )
    penClass_set_attribute( var_PenTypeHouse, 'orientation', 0  )
    penClass_set_attribute( var_PenTypeHouse, 'thickness', 2  )
    penClass_set_attribute( var_PenTypeHouse, 'pressure', 1  )



    var_penHouse = Pen(  var_PenTypeHouse )


    pen_action(var_CanvasHouse, var_penHouse, "down")


    pen_action(var_CanvasHouse, var_penHouse, "forward", value=200)


    pen_action(var_CanvasHouse, var_penHouse, "right", value=90, units='º')
    ...
    pen_action(var_CanvasHouse, var_penHouse, "up")


    var_penHouse.set_attribute( 'position', (100, 300)  )


    var_penHouse.set_attribute( 'color', "red"  )


    pen_action(var_CanvasHouse, var_penHouse, "down")


    pen_action(var_CanvasHouse, var_penHouse, "left", value=45, units="º")
    pen_action(var_CanvasHouse, var_penHouse, "forward", value=140.7)
    ...
    var_penHouse.set_attribute( 'orientation', 0  )


    var_penHouse.set_attribute( 'position', (200, 400)  )


    var_penHouse.set_attribute( 'color', "gray"  )


    pen_action(var_CanvasHouse, var_penHouse, "down")


    pen_action(var_CanvasHouse, var_penHouse, "forward", value=50)


    pen_action(var_CanvasHouse, var_penHouse, "right", value=90, units='º')


    pen_action(var_CanvasHouse, var_penHouse, "forward", value=100)

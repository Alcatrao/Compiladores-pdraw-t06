...
def main():
    ...
    pen_action(var_Win, var_p1, "down")


    pen_action(var_Win, var_p1, "forward", value=10)


    pen_action(var_Win, var_p1, "left", value=90, units="º")
    ...
    var_canvas_0 = GraphWin("canvas_0", 400, 400)     # todos as novas pens criadas vão desenhar neste canvas, até que um novo canvas seja criado


    var_psec = Pen(   )


    pen_execute(var_canvas_0, var_psec, "p1.ipdraw")
    try:
        var_Win.getMouse()
        var_Win.close()
    except:

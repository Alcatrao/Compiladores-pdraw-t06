...
def main():
    ...
    var_Canvas5 = GraphWin("Canvas5", 1000, 1000)     # todos as novas pens criadas vão desenhar neste canvas, até que um novo canvas seja criado


    # criar pen_class default, e modificar-lhe os atributos indicados 
    var_PenType5 = {}
    var_PenType5["pos"] = (10,10)
    var_PenType5["color"] = "red"
    var_PenType5["orientation"] = 0
    var_PenType5["thickness"] = 1
    var_PenType5["pressure"] = 0
    var_PenType5["levitate"] = False


    # meter os valores desejados na pen_class criada
    penClass_set_attribute( var_PenType5, 'color', "red"  )
    penClass_set_attribute( var_PenType5, 'position', (500, 500)  )
    penClass_set_attribute( var_PenType5, 'orientation', 0  )
    penClass_set_attribute( var_PenType5, 'thickness', 2  )
    penClass_set_attribute( var_PenType5, 'pressure', 0  )



    var_p5 = Pen(  var_PenType5 )


    var_p6 = Pen(  var_PenType5 )


    var_p7 = Pen(  var_PenType5 )


    var_p5.set_attribute( 'color', "red"  )


    var_p6.set_attribute( 'color', "green"  )


    var_p7.set_attribute( 'color', "blue"  )


    var_p5.set_attribute( 'position', (300, 300)  )


    var_p6.set_attribute( 'position', (700, 300)  )


    var_p7.set_attribute( 'position', (500, 700)  )


    pen_action(var_Canvas5, var_p5, "down")


    pen_action(var_Canvas5, var_p6, "down")


    pen_action(var_Canvas5, var_p7, "down")


    var_i = int(0)
    while( (var_i < 4) ):
        pen_action(var_Canvas5, var_p5, "forward", value=100)
        pen_action(var_Canvas5, var_p5, "right", value=90)
        pen_action(var_Canvas5, var_p6, "forward", value=100)
        pen_action(var_Canvas5, var_p6, "left", value=90)
        pen_action(var_Canvas5, var_p7, "forward", value=100)
        pen_action(var_Canvas5, var_p7, "right", value=90)
        var_i = ((var_i + 1))


    pen_action(var_Canvas5, var_p5, "up")


    pen_action(var_Canvas5, var_p6, "up")


    pen_action(var_Canvas5, var_p7, "up")
